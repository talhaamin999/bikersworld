...
class mechanicsReviewsNormalUser extends StatefulWidget {
  @override
  _mechanicsReviewsNormalUserState createState() => _mechanicsReviewsNormalUserState();
}

class _mechanicsReviewsNormalUserState extends State<mechanicsReviewsNormalUser> {
  int currentIndex;
